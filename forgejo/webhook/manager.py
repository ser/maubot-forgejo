...
class WebhookManager:
    ...
    async def set_forgejo_id(self, info: WebhookInfo, forgejo_id: int) -> WebhookInfo:
        await self._db.set_webhook_github_id(info.id, forgejo_id)
    ...
    async def transfer_rooms(
        self, old_room: RoomID, new_room: RoomID
    ) -> list[WebhookInfo]:
